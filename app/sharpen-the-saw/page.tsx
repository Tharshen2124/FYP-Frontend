        ...
        d.id === editingId.dimId
          ? {
              ...
              activities: d.activities.map(a =>
                a.id === editingId.actId ? { ...a, text: editText.trim() } : a
              ),
            }
          : d
      )
                ...
                >
                    ...
                    {dim.activities.map(act => (
                      ...
                      >
                        {editingId?.dimId === dim.id && editingId?.actId === act.id ? (
                          ...
                          <div className="flex items-center gap-3 flex-1 min-w-0">
                            ...
                            <span
                              ...
                              onClick={() => startEdit(dim.id, act.id, act.text)}
                            >
                              {act.text}
                            </span>
                          </div>
                        ...
                        <Button
                          variant="ghost"
                          size="sm"
                          onClick={() => deleteActivity(dim.id, act.id)}
                  ...
                  <div className="flex gap-2">
                    <Input
                      ...
                      onKeyDown={e => {
                        if (e.key === "Enter") addActivity(dim.id)
                      }}
                      className="bg-muted border-border text-foreground placeholder:text-muted-foreground"
                    />
                    <Button
                      onClick={() => addActivity(dim.id)}
