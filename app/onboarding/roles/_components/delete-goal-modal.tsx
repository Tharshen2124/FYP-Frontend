...
interface Props {
  target: { roleId: string; goal: Goal } | null
  onCancel: () => void
  onConfirm: () => void
}

export function DeleteGoalModal({ target, onCancel, onConfirm }: Props) {
  return (
      ...
      <AlertDialogContent className="bg-card border-border text-foreground">
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="text-muted-foreground font-serif">
            ...
            <span className="font-bold text-foreground">&ldquo;{target?.goal.text}&rdquo;</span>?
            <br /><br />
