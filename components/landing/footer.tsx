    ...
    <footer className="bg-foreground text-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="py-16 grid grid-cols-2 md:grid-cols-6 gap-8">
          ...
          <div className="col-span-2">
            ...
            <p className="mt-4 text-sm text-background/60 max-w-xs">
              Principle-centered planning for highly effective people. Based on
              the timeless framework from The 7 Habits.
            </p>
          ...
          {Object.entries(footerLinks).map(([category, links]) => (
            <div key={category}>
              <h4 className="font-semibold text-sm text-background mb-4">
                {category}
              </h4>
        ...
        <div className="py-6 border-t border-background/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm text-background/60">
            Made with intention for effective people.
          </p>
        </div>
      </div>
    </footer>
